...
/* Pilares implementados:
    - Polimorfismo: Se implementa al usar una referencia de la clase abstracta `Paciente`, pero instanciando objetos de sus clases concretas (por ejemplo, `PacienteAdulto` o `PacientePediatrico`). Esto permite que el comportamiento de los métodos varíe según el tipo específico de objeto.
